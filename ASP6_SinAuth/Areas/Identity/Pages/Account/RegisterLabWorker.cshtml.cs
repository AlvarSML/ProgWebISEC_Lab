...
namespace ASP6_SinAuth.Areas.Identity.Pages.Account
{
    public class RegisterLabWorkerModel : PageModel
    {
        private readonly SignInManager<User> _signInManager;
        private readonly UserManager<User> _userManager;
        private readonly IUserStore<User> _userStore;
        private readonly IUserEmailStore<User> _emailStore;
        private readonly ILogger<RegisterLabWorkerModel> _logger;
        private readonly IEmailSender _emailSender;
        private readonly ctxDatos _context;

        public RegisterLabWorkerModel(
            UserManager<User> userManager,
            IUserStore<User> userStore,
            SignInManager<User> signInManager,
            ILogger<RegisterLabWorkerModel> logger,
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user = new LaboratoryWorker
                {
                    Name = Input.FirstName,
                    FirstName = Input.FirstName,
                    LastName = Input.LastName,
                    NationalID = Input.NationalID,
                    laboratory = _context.Laboratory.Find(Input.laboratoryID)
                };
                ...
                if (result.Succeeded)
                {
                    ...
                    if (user != null)
                    {
                        result = await _userManager.AddToRoleAsync(user, "LaboratoryManager");
                    }
